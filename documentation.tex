...
\title{Documentation of the KSP Physics}
...
\begin{abstract}
  ...
  This documents contains information about the physics of Kerbal Space Program \cite{KSP} 
...
Fortunately I dealt with nearly all physics in KSP during my Ascent
Optimizer perl-project \cite{PAO}.


\section{Conventions}

We denote by $\Pos$, $\Vel$ and $M$ the position vector, velocity
vector and the mass of the ship respectively.

$\Pos_X, \Pos_Y \textrm{ and } \Pos_Z$ denote the X, Y and Z
components of the vector.

Distance denotes the distance to the planets center and altitude the
distance to the surfaces sea level.
...
This information is based on \url{http://wiki.kerbalspaceprogram.com/wiki/Kerbin}.
...
Due to the rotation of the planet, the speed relative to the rotation
of the planet is different from the orbit speed. We call that speed
the ground speed.
