...
\item \index{Spehre of Influence} Radius of Spehre of Influence $Soi^{(Name)}$ in m \footnote{It should be noted that the Spehre of Influence is actually calculated
...
In the real world every Planetary Body exercised gravitation to all
...
areas are mostly spheric and their radius is called ``Sphere of
Influence''.  This Radius can be calculated according to the formula
in \cite{SphereOfInfluence}.

The Add-On Principia \cite{principia} (currently under development)
intends to implement a more realistic N-Body-Physics.
