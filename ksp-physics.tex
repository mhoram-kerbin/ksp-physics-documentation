...
The gravity force $\F{G}$ is directed towards the planets core and gets lower
...
There are several forces that induct a rotation on a ship.
...
orbital momentum vector and $\oa{e}$ the eccentricity vector.
