...
continent below. So the local gravity differs for locations at the
same altitude above a planet while in KSP the local gravity is
constant for all locations on the same altitude.
