...
In otbital mechanics there are three aequivalent parameters that
...
\nu & = 2\cdot\atan2\left(\sqrt{1+e}\cdot \cos\left(\frac{E}{2}\right), \sqrt{1-e}\cdot \sin\left(\frac{E}{2}\right)\right)
\end{align}

\subsubsection{Eccentric Anomaly to Mean Anomaly}

We get the Mean Anomaly by the formula

\begin{align}
M & = E - e\cdot \sin(E)
\end{align}

\subsubsection{Mean Anomaly to Eccentric Anomaly}
