...
\index{Periapsis} periapsis $Peri$ (in the meaning distance to the
Planets center) as
...
$r$ to the Planets center is according to \cite{OrbitVelocity}
...
\bibitem{OrbitVelocity}
  \url{http://en.wikipedia.org/wiki/Orbital_mechanics#Velocity}
